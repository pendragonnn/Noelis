...
class Blog extends CI_Controller {
    ...
    public function add()
    {
        ...
        if($this->form_validation->run() === TRUE){
            ...
            if($id){
                $this->session->set_flashdata('message', '<div class="alert alert-succes">Data berhasil disimpan</div>');
                redirect('/');
            } else {
    ...
    public function delete($id)
    {
        ...
        if($result)
        {
            $this->session->set_flashdata('message', '<div class="alert alert-succes">Data berhasil dihapus</div>');
            redirect('/');
        }else 
        {
